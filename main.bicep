...
param vmName string = '${prefix}-CTXSF05'

@description('AD Domain FQDN')
param adDomain string = 'libremax.com'
    ...
    ipConfigurations: [
      {
        ...
        properties: {
          ...
          subnet: {
            id: '/subscriptions/24fe3fd6-33b3-4e09-9cb2-bf0ef40f3adc/resourceGroups/Infrastructure_Networking/providers/Microsoft.Network/virtualNetworks/Core_VNet/subnets/server_subnet'
          }
        }
      }
    ]
